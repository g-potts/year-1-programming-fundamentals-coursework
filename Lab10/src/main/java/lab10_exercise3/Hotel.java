...
public class Hotel {
	...
	/**
	 * @return the list guests at the hotel. (Note that it is not ideal to return
	 *         the list, but simple for this example.)
	 */
	...
	/**
	 * Prints the list of guests at the hotel. This uses the string representation
	 * of each guest define by the toString method in the interface.
	 */
